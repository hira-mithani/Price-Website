...
import { selectSelectedMobile, setSelectedMobile } from "../../../features/mobileSlice";

const MobileDetail = () => {
  const { id } = useParams();
  const navigate = useNavigate();
  const dispatch = useDispatch();
  const product = useSelector(selectSelectedMobile);

  React.useEffect(() => {
    dispatch(setSelectedMobile(parseInt(id)));
  }, [dispatch, id]);
